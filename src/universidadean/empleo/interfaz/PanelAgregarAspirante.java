...
public class PanelAgregarAspirante extends JPanel implements ActionListener {
    ...
    /**
     * Este es el campo para la cédula del aspirante
     */
    private JTextField txtCedula;

    /**
     * Esta es la etiqueta para la cedula del aspirane
     */
        ...
        if (AGREGAR.equals(comando)) {
            try {
                ...
                if (nombre.equals("") || profesion.equals("") || imagen.equals("") || telefono.equals("") || nombre.equals(" ")) {
                    ...
                    if (aniosExperiencia < 1 || edad < 1 || cedula < 1) {
                        JOptionPane.showMessageDialog(this, "Los campos cedula, edad y años de experiencia deben ser números enteros positivos", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                    else {
                        principal.agregarAspirante(cedula, nombre, profesion, aniosExperiencia, edad, telefono, imagen);
                        txtCedula.setText("");
