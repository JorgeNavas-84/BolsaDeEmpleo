...
public class PanelInformacion extends JPanel {
    ...
    // -----------------------------------------------------------------
    /**
     * Es el campo para la cédula del aspirante
     */
    ...
    /**
     * Esta es la etiqueta para la cédula del aspirante
     */
    ...
    public void mostrarDatos(Aspirante aspirante) {
        try {
            ...
            txtAniosExperiencia.setText(String.valueOf(aspirante.getAniosExperiencia() + " año(s)"));
            ...
            txtEdad.setText(String.valueOf(aspirante.getEdad() + " años"));

            txtNombre.setText(aspirante.getNombre());

            txtCedula.setText(String.valueOf(aspirante.getCedula()));

            validate();
        }
        catch (IOException e) {
            JOptionPane.showMessageDialog(this, "Error al cargar la imagen del aspirante " + aspirante.getCedula(), "Error", JOptionPane.ERROR_MESSAGE);
        }
